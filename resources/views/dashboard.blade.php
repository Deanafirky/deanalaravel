...
<div class="container mt-5">
    <h1 class="font-bold text-2xl text-center">Anathan's Coffee!</h1>
   
    <div class="row mt-4">
        <div class="col-md-3">
            <div class="card text-white bg-success mb-4" style="min-height: 150px;">
                <div class="card-body d-flex flex-column justify-content-center align-items-center">
                    <i class="fas fa-calendar-day fa-3x mb-2"></i> <!-- Ikon untuk Input Hari Ini -->
        ...
        <div class="col-md-3"> 
            <div class="card text-white bg-warning mb-4" style="min-height: 150px;">
                <div class="card-body d-flex flex-column justify-content-center align-items-center">
                    <i class="fas fa-calendar-alt fa-3x mb-2"></i> <!-- Ikon untuk Input Kemarin -->
        ...
        <div class="col-md-3">
            <div class="card text-white bg-info mb-4" style="min-height: 150px;">
                <div class="card-body d-flex flex-column justify-content-center align-items-center">
                    <i class="fas fa-calendar fa-3x mb-2"></i> <!-- Ikon untuk Input Bulan Ini -->
        ...
        <div class="col-md-3">
            <div class="card text-white bg-primary mb-4" style="min-height: 150px;">
                <div class="card-body d-flex flex-column justify-content-center align-items-center">
                    <i class="fas fa-chart-bar fa-3x mb-2"></i> <!-- Ikon untuk Total Input -->
